...
We ran multiple comparisons and found that the infected group was the only group with a significant change in hue when it was contrasted to the uninfected and control groups. 
...
aphidCont <- tidy(contrast(aphidMeans, 
                     method = list(
                       #                        C     U     I 
                       'L1: C,U vs I '    = c( -1,    -1,    2 ),
                       'L2: U vs I'       = c(  0,    -1,    1 )
